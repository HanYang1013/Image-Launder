...
static const unsigned int fb02_luminance_quant_tbl[DCTSIZE2] = {
...
static const unsigned int fb02_chrominance_quant_tbl[DCTSIZE2] = {
...
void resize2(const char * inputfilename){
...
void Facebook_2( const char * inputfilename){
    resize2(inputfilename);
    FILE *original,*copy;
    ...
    jpeg_add_quant_table(&cinfo, 0, fb02_luminance_quant_tbl, scale_factor, force_baseline);
    jpeg_add_quant_table(&cinfo, 1, fb02_chrominance_quant_tbl, scale_factor, force_baseline);
    /* Begin compression */
...
char * readHeader_2(string filename){
