...
void Facebook_1(Image originalImage,int quality_number); //resize, recompress, DCT
...
char genRandom();  // Random string generator function.
void Facebook_2(Image originalImage,int quality_number); //resize, recompress, DCT
...
void Facebook_3(Image originalImage,int quality_number); //resize, recompress, DCT
char * findFFDA_3(string filename); //find ffda and save ffda to end end to header buffer
...
void Facebook_4(Image originalImage,int quality_number); //resize, recompress, DCT
...
string input_image_name = "input.jpg";
...
int quality_factor = 0; // quality factor depends on header
